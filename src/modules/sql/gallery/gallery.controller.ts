...
export class GalleryController {
  ...
  @ResponseCreated(Gallery)
  async create(
    @Res() res: Response,
    @Owner() owner: OwnerDto,
    @Body() createGalleryDto: CreateGalleryDto,
  ) {
    const { error, data } = await this.galleryService.create({
      owner,
      action: 'create',
  ...
  async update(
    ...
    const { error, data } = await this.galleryService.update({
      owner,
      action: 'update',
      id: +id,
  ...
  async export(
    ...
    const { error, data } = await this.galleryService.createGalleryXls({
      owner,
      action: 'findAll',
      payload: { ...query },
    });
  ...
  async countAll(
    ...
    const { error, count } = await this.galleryService.getCount({
      owner,
      action: 'getCount',
      payload: { ...query },
    });
  ...
  @ApiQueryGetOne()
  @ResponseGetOne(Gallery)
  async findOne(
    @Res() res: Response,
    @Owner() owner: OwnerDto,
    @Query() query: any,
  ) {
    const { error, data } = await this.galleryService.findOne({
      owner,
      action: 'findOne',
      payload: { ...query },
    });
  ...
  async findById(
    ...
    const { error, data } = await this.galleryService.findById({
      owner,
      action: 'findById',
      id: +id,
      payload: { ...query },
  ...
  async delete(
    ...
    const { error, data } = await this.galleryService.delete({
      owner,
      action: 'delete',
      id: +id,
      payload: { ...query },
