...
export class GalleryCategoryController {
  ...
  @ResponseCreated(GalleryCategory)
  async create(
    @Res() res: Response,
    @Owner() owner: OwnerDto,
    @Body() createGalleryCategoryDto: CreateGalleryCategoryDto,
  ) {
    const { error, data } = await this.galleryCategoryService.create({
      owner,
      action: 'create',
      body: createGalleryCategoryDto,
    });
  ...
  @ResponseUpdated(GalleryCategory)
  async update(
    @Res() res: Response,
    @Owner() owner: OwnerDto,
    @Param('id') id: number,
    ...
    const { error, data } = await this.galleryCategoryService.update({
      owner,
      action: 'update',
      id: +id,
      body: updateGalleryCategoryDto,
    });
  ...
  async findAll(
    ...
    const { error, data, offset, limit, count } =
      await this.galleryCategoryService.findAll({
        owner,
        action: 'findAll',
        payload: { ...query },
      });
  ...
  async countAll(
    ...
    const { error, count } = await this.galleryCategoryService.getCount({
      owner,
      action: 'getCount',
      payload: { ...query },
    });
  ...
  @ApiQueryGetOne()
  @ResponseGetOne(GalleryCategory)
  async findOne(
    @Res() res: Response,
    @Owner() owner: OwnerDto,
    @Query() query: any,
  ) {
    const { error, data } = await this.galleryCategoryService.findOne({
      owner,
      action: 'findOne',
      payload: { ...query },
    });
  ...
  async findById(
    ...
    const { error, data } = await this.galleryCategoryService.findById({
      owner,
      action: 'findById',
      id: +id,
      payload: { ...query },
  ...
  @ApiQueryDelete()
  @ResponseDeleted(GalleryCategory)
  async delete(
    @Res() res: Response,
    @Owner() owner: OwnerDto,
    @Param('id') id: number,
    ...
    const { error, data } = await this.galleryCategoryService.delete({
      owner,
      action: 'delete',
      id: +id,
      payload: { ...query },
