...
export class ReferredCouponController {
  ...
  async create(
    ...
    @Body() createReferredCouponDto: CreateReferredCouponDto,
  ) {
    const { error, data } = await this.referredCouponService.create({
      owner,
      action: 'create',
      body: createReferredCouponDto,
    });
  ...
  async update(
    ...
    @Owner() owner: OwnerDto,
    @Param('id') id: number,
    @Body() updateReferredCouponDto: UpdateReferredCouponDto,
  ) {
    const { error, data } = await this.referredCouponService.update({
      owner,
      action: 'update',
      id: +id,
      body: updateReferredCouponDto,
    });
  ...
  async findAll(
    ...
    const { error, data, offset, limit, count } =
      await this.referredCouponService.findAll({
        owner,
        action: 'findAll',
        payload: { ...query },
      });
  ...
  async countAll(
    ...
    const { error, count } = await this.referredCouponService.getCount({
      owner,
      action: 'getCount',
      payload: { ...query },
    });
  ...
  async findOne(
    ...
    const { error, data } = await this.referredCouponService.findOne({
      owner,
      action: 'findOne',
      payload: { ...query },
    });
  ...
  async findById(
    ...
    const { error, data } = await this.referredCouponService.findById({
      owner,
      action: 'findById',
      id: +id,
      payload: { ...query },
  ...
  async delete(
    ...
    const { error, data } = await this.referredCouponService.delete({
      owner,
      action: 'delete',
      id: +id,
      payload: { ...query },
